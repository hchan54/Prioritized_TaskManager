...
public class Task {
  ...
  public int compareTo(Task other, CompareCriteria criteria) {
      return switch (criteria) {
          case TITLE -> other.title.compareTo(this.title); //reverse lexicographical comparision
          case TIME -> this.time - other.time;
          case LEVEL -> this.priorityLevel.compareTo(other.priorityLevel);
      };
  }
}
